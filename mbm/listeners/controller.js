...
const buttonFiles = grabFiles("./mbm/listeners/button/")
const modalSubmitFiles = grabFiles("./mbm/listeners/modalSubmit/")
const selectMenuFiles = grabFiles("./mbm/listeners/selectMenu/")
